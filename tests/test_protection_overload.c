...
typedef struct {
    unsigned int id;
    float current;
    const t_simulated_current_element *simulated_currents;
...
float Sensor_Read_Mock(t_simulated_current_element *simulated_currents, float time) {
    ...
    for (int i = 0; simulated_currents[i].time != END_SIMULATION; i++) {
        if (time >= simulated_currents[i].time) {
            current = simulated_currents[i].current;
        }
    }
    return current;
}
...
const t_test_case test_cases_fixed_current[] = {
    {.id = 100, .current = 0.2f, .simulated_currents = NULL, .expected_state = ST_IDLE, .description = "Low current"},
    {.id = 101, .current = 0.8f, .simulated_currents = NULL, .expected_state = ST_IDLE, .description = "Normal current"},
    {.id = 102, .current = 1.0f, .simulated_currents = NULL, .expected_state = ST_IDLE, .description = "Nominal current"},
    {.id = 103, .current = 1.2f, .simulated_currents = NULL, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 2.27f, .description = "Overload current 1,2 x Itrip"},
    {.id = 104, .current = 1.4f, .simulated_currents = NULL, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 1.04f, .description = "Overload current 1,4 x Itrip"},
    {.id = 105, .current = 1.6f, .simulated_currents = NULL, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 0.64f, .description = "Overload current 1,6 x Itrip"},
    {.id = 106, .current = 2.0f, .simulated_currents = NULL, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 0.33f, .description = "Overload current 2,0 x Itrip"},
    {.id = 107, .current = 3.0f, .simulated_currents = NULL, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 0.12f, .description = "Overload current 3,0 x Itrip"}
 };
...
const t_test_case test_cases_variable_current[] = {
    ...
    {.id = 202, .current = 1.0f, .simulated_currents = simulated_currents_202, .expected_state = ST_IDLE, .description = "Nominal current"},
    {.id = 203, .current = 1.2f, .simulated_currents = simulated_currents_203, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 2.27f, .description = "Overload current 1,2 x Itrip"},
    {.id = 204, .current = 1.4f, .simulated_currents = simulated_currents_204, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 1.04f, .description = "Overload current 1,4 x Itrip"},
    {.id = 205, .current = 1.6f, .simulated_currents = simulated_currents_205, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 0.64f, .description = "Overload current 1,6 x Itrip"},
    {.id = 206, .current = 2.0f, .simulated_currents = simulated_currents_206, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 0.33f, .description = "Overload current 2,0 x Itrip"},
    {.id = 207, .current = 3.0f, .simulated_currents = simulated_currents_207, .expected_state = ST_OVERLOAD_TRIGGERED, .expected_time = 0.12f, .description = "Overload current 3,0 x Itrip"}
 };
